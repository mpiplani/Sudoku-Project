...
diag_unit = [[rows[i] + cols[i] for i in range(len(rows))] , [rows[-i-1] + cols[i] for i in range(len(rows))]]
if True:
...
def naked_twins(values):
    ...
    naked_twins = [[box1, box2] for box1 in possible_naked_twins for box2 in peers[box1] if set(values[box1]) == set(values[box2])]
